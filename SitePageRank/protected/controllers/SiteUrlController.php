...
class SiteUrlController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['SiteUrl'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->SiteID));
		}
	 ...
	 * @param SiteUrl $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='site-url-form')
		{
